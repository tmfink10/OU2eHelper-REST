...
namespace OU2eHelperApi.Migrations
{
    ...
    [Migration("20210120001358_SeedPlayerCharacterTable")]
    partial class SeedPlayerCharacterTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OU2eHelperModels.Models.BaseAbility", b =>
                {
                    ...
                    b.Property<bool>("AdvancesSkills")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("OU2eHelperModels.Models.BaseSkill", b =>
                {
                    ...
                    b.Property<int>("PrimaryAttributeBaseAttributeId")
                        .HasColumnType("int");

                    b.Property<int?>("PrimaryAttributeId")
                        .HasColumnType("int");

                    b.Property<int>("SecondaryAttributeBaseAttributeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PlayerAbilityId");

                    b.HasIndex("PrimaryAttributeId");

                    b.HasIndex("SecondaryAttributeId");
            ...
            modelBuilder.Entity("OU2eHelperModels.Models.PlayerAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("BaseAttributeId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OU2eHelperModels.Models.PlayerCharacter", b =>
                {
                    ...
                    b.Property<int>("CompetencePoints")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OU2eHelperModels.Models.PlayerSkill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OU2eHelperModels.Models.PlayerTrainingValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("BaseTrainingValueId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BaseTrainingValueId");

                    b.HasIndex("PlayerCharacterId");

                    b.ToTable("PlayerTrainingValues");
                });
            ...
            modelBuilder.Entity("OU2eHelperModels.Models.BaseSkill", b =>
                {
                    ...
                    b.HasOne("OU2eHelperModels.Models.PlayerAbility", null)
                        .WithMany("Supports")
                        .HasForeignKey("PlayerAbilityId");

                    b.HasOne("OU2eHelperModels.Models.BaseAttribute", "PrimaryAttribute")
                        .WithMany()
                        .HasForeignKey("PrimaryAttributeId");

                    b.HasOne("OU2eHelperModels.Models.BaseAttribute", "SecondaryAttribute")
                        .WithMany()
                        .HasForeignKey("SecondaryAttributeId");
            ...
            modelBuilder.Entity("OU2eHelperModels.Models.PlayerAbility", b =>
                {
                    ...
                    b.HasOne("OU2eHelperModels.Models.PlayerCharacter", null)
                        .WithMany("Abilities")
            ...
            modelBuilder.Entity("OU2eHelperModels.Models.PlayerAttribute", b =>
                {
                    b.HasOne("OU2eHelperModels.Models.BaseAttribute", "BaseAttribute")
                        .WithMany()
                        .HasForeignKey("BaseAttributeId");
            ...
            modelBuilder.Entity("OU2eHelperModels.Models.PlayerCharacter", b =>
                {
                    b.HasOne("OU2eHelperModels.Models.PlayerAttribute", "Empathy")
                        .WithMany()
                        .HasForeignKey("EmpathyId");

                    b.HasOne("OU2eHelperModels.Models.PlayerAttribute", "Perception")
                        .WithMany()
                        .HasForeignKey("PerceptionId");

                    b.HasOne("OU2eHelperModels.Models.PlayerAttribute", "Strength")
                        .WithMany()
                        .HasForeignKey("StrengthId");

                    b.HasOne("OU2eHelperModels.Models.PlayerAttribute", "Willpower")
                        .WithMany()
                        .HasForeignKey("WillpowerId");

                    b.Navigation("Empathy");
            ...
            modelBuilder.Entity("OU2eHelperModels.Models.PlayerSkill", b =>
                {
                    b.HasOne("OU2eHelperModels.Models.BaseSkill", "BaseSkill")
                        .WithMany()
            ...
            modelBuilder.Entity("OU2eHelperModels.Models.PlayerTrainingValue", b =>
                {
                    b.HasOne("OU2eHelperModels.Models.BaseTrainingValue", "BaseTrainingValue")
                        .WithMany()
                        .HasForeignKey("BaseTrainingValueId");

                    b.HasOne("OU2eHelperModels.Models.PlayerCharacter", null)
                        .WithMany("TrainingValues")
                        .HasForeignKey("PlayerCharacterId");

                    b.Navigation("BaseTrainingValue");
                });
